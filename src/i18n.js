    ...
    projects: {
      ...
      items: [
        ...
        },
        {
          ...
          description:
            'Site vitrine avec calendrier événementiel dynamique pour une école de survie en nature. Frontend vanilla JS, backend Directus (REST API), déployé sur Cloudflare.',
        ...
        },
        {
          title: 'RNBP Canada',
          description:
            "Registre national des biens personnels. Plateforme permettant d'enregistrer, protéger et retrouver des biens de valeur.",
      ...
      items: [
        {
          title: 'Portfolio v2',
          description:
            'Personal website built with React and Tailwind CSS v4. SEO optimization documented as a case study.',
          tags: ['React', 'Tailwind CSS', 'Vite', 'SEO'],
          image: '/share-card.png',
          github: 'https://github.com/Alexandre-Lessard/al-si.com',
          githubOnly: true,
        },
        {
          title: 'Terra Indomita',
          description:
            'Marketing site with dynamic event calendar for an outdoor survival school. Vanilla JS frontend, Directus backend (REST API), deployed on Cloudflare.',
          tags: ['JavaScript', 'Directus', 'REST API', 'Cloudflare'],
          gradient: 'bg-gradient-to-br from-green-700/20 to-green-900/10',
          image: '/terra-indomita-logo.svg',
          url: 'https://terra-indomita.ca/',
        ...
        },
        {
          title: 'RNBP Canada',
          description:
            'National personal property registry. Platform for registering, protecting and recovering valuable possessions.',
          tags: ['Web app', 'SaaS', 'Cloudflare'],
          image: '/rnbp-preview.png',
          url: 'https://rnbp.ca/',
        },
